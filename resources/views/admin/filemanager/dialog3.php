<?php
$config = include 'config/config_brand.php';
...
while($cycle && $i < $max_cycles){
    ...
    if (file_exists($current_path.$parent."config_brand.php"))
    {
		require_once $current_path.$parent."config_brand.php";
		$cycle = FALSE;
    }
...
<!-- header div end -->
	...
	<div class="span12">
	    ...
	    <br/>
	    <div class="alert alert-error">There is an error! The upload folder there isn't. Check your config_brand.php file. </div>
	    <?php }else{ ?>
