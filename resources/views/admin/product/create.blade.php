            ...
            <div class="col-xs-7 col-md-offset-3">
                <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('name')? 'has-error':'' }}">
                            ...
                            <input required="required"  type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Product name">
                        ...
                        <div class="form-group {{ $errors->has('meta_tag_description')? 'has-error':'' }}">
                            ...
                            <textarea    name="meta_tag_description" id="meta_tag_description" class="form-control" rows="3" placeholder="Enter Meta Tag Description">{{ old('meta_tag_description') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('meta_keyword_description')? 'has-error':'' }}">
                            ...
                            <textarea   name="meta_keyword_description" id="meta_keyword_description" class="form-control" rows="3" placeholder="Enter Meta Keyword Description">{{ old('meta_keyword_description') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('description')? 'has-error':'' }}">
                            ...
                            <textarea  required name="description" id="description" class="form-control" rows="3" placeholder="Enter  Description">{{ old('description') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('product_tag')? 'has-error':'' }}">
                            <label class="control-label" for="exampleInputEmail1">Product Tag <span class="label-hint">( Comma separated )</span></label>

                            <input   type="text" class="form-control" name="product_tag" id="product_tag" value=" " placeholder="Product Tag">
        ...
        <div class="row setup-content" id="step-2">
            <div class="col-xs-7 col-md-offset-3">
                    ...
                    <div class="form-group {{ $errors->has('model')? 'has-error':'' }}">
                        ...
                        <input required="required"  type="text" class="form-control" name="model" id="model" value="{{ old('model') }}" placeholder="Product Model">
                    ...
                    <div class="form-group {{ $errors->has('sku')? 'has-error':'' }}">
                        ...
                        <input  type="text" class="form-control" name="sku" id="sku" value="{{ old('sku') }}" placeholder="SKU">
                    ...
                    <div class="form-group {{ $errors->has('upc')? 'has-error':'' }}">
                        ...
                        <input   type="text" class="form-control" name="upc" id="upc" value="{{ old('upc') }}" placeholder="UPC">
                    ...
                    <div class="form-group {{ $errors->has('mpn')? 'has-error':'' }}">
                        ...
                        <input   type="text" class="form-control" name="mpn" id="mpn" value="{{ old('mpn') }}" placeholder="MPN">
                        {!! $errors->has('upc')? '<p class="text-red">'.$errors->first('upc') .'</p>':'' !!}
                    </div>
                    ...
                    <div class="form-group {{ $errors->has('price')? 'has-error':'' }}">
                        ...
                        <input required  type="text" class="form-control" name="price" id="price" value="{{ old('price') }}" placeholder="Price">
                    ...
                    <div class="form-group {{ $errors->has('color')? 'has-error':'' }}">
                        ...
                        <input  type="text" class="form-control auto" name="color" id="color" value="{{ old('color') }}" placeholder="color">
                ...
                <div class="form-group {{ $errors->has('quantity')? 'has-error':'' }}">
                    ...
                    <input required  type="text" class="form-control" name="quantity" id="quantity" value="{{ old('quantity') }}" placeholder="Stock Quantity">
                    ...
                    <div class="form-group {{ $errors->has('minimum_quantity')? 'has-error':'' }}">
                        ...
                        <input required  type="text" class="form-control" name="minimum_quantity" id="minimum_quantity" value="{{ old('minimum_quantity') }}" placeholder="Minimum Quantity">
                    ...
                    <div class="form-group  {{ $errors->has('date_available')? 'has-error':'' }}">
                        ...
                        <div class="input-group" >
                            ...
                            <input  id="date_available" name="date_available" class="form-control" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask="" type="text" {{ old('date_available') }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                ...
                                <input id="dimension_length" name="dimension_length" class="form-control" placeholder="Length" type="text">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input id="dimension_width" width="dimension_width" class="form-control" placeholder="Width" type="text">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input id="dimension_height" name="dimension_height" class="form-control" placeholder="Height" type="text">
                    ...
                    <div class="form-group  {{ $errors->has('length_class')? 'has-error':'' }}">
                        ...
                        <select id="length_class" name="length_class" class="form-control">
                            ...
                            @foreach($all_length as $all_length_item)
                                ...
                                <option value="{{$all_length_item->value}}">{{$all_length_item->name}}</option>
                    ...
                    <div class="form-group  {{ $errors->has('weight_class')? 'has-error':'' }}">
                        ...
                        <select  id="weight_class" name="weight_class" class="form-control">
                            ...
                            @foreach($all_weight as $all_weight_item)
                                ...
                                <option value="{{$all_weight_item->value}}">{{$all_weight_item->name}}</option>
                    ...
                    <div class="form-group {{ $errors->has('weight')? 'has-error':'' }}">
                        ...
                        <input   type="text" class="form-control" name="weight" id="weight" value="{{ old('weight') }}" placeholder="Weight">
            ...
            <div class="col-xs-6 col-md-offset-3">
                <div class="col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('hot_label')? 'has-error':'' }}">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="hot_label" id="hot_label">
                                    Is Hot Label
                                </label>
                            </div>
                    ...
                    <div class="form-group {{ $errors->has('special_deal')? 'has-error':'' }}">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="special_deal" id="special_deal" >
                                Is Special Deal
                            </label>
                        </div>
                    ...
                    <div class="form-group {{ $errors->has('is_pre_order')? 'has-error':'' }}">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="is_pre_order" id="is_pre_order">
                    ...
                    <div class="form-group {{ $errors->has('pre_order_amount')? 'has-error':'' }}">
                        ...
                        <input   type="text" class="form-control" name="pre_order_amount" id="pre_order_amount" value="{{ old('pre_order_amount') }}" placeholder="Pre Order Amount ( In TK)">
                ...
                <div class="col-md-12">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group {{ $errors->has('tax_amount')? 'has-error':'' }}">
                            ...
                            <input   type="text" class="form-control" name="tax_amount" id="tax_amount" value="{{ old('tax_amount') }}" placeholder="Tax Amount ( In Percent)">
            ...
            <div class="col-md-12">
                ...
                <fieldset>
                    ...
                    <div class="form-group  {{ $errors->has('	manufacturer_id')? 'has-error':'' }}">
                        ...
                        <select id="manufacturer_id" name="manufacturer_id" class="form-control">
                            ...
                            @foreach($manufacture as $manufacture_item)
                                ...
                                <option value="{{$manufacture_item->id}}">{{$manufacture_item->name}}</option>
                    ...
                    <div class="form-group {{ $errors->has('tax_amount')? 'has-error':'' }}">
                        ...
                        <input   type="text" class="form-control" name="reward_point" id="reward_point" value="{{ old('reward_point') }}" placeholder="Reward Point">
                    ...
                    <div class="form-group {{ $errors->has('discount')? 'has-error':'' }}">
                        ...
                        <input   type="text" class="form-control" name="discount" id="discount" value="{{ old('discount') }}" placeholder="Discount ( In Percent)">
                    ...
                    <div class="form-group {{ $errors->has('inside_dhaka_charge')? 'has-error':'' }}">
                        ...
                        <input required  type="text" class="form-control" name="inside_dhaka_charge" id="inside_dhaka_charge" value="{{ old('inside_dhaka_charge') }}" placeholder="Inside Dhaka Shipping Charge">
                    ...
                    <div class="form-group {{ $errors->has('other_charge')? 'has-error':'' }}">
                        ...
                        <input  required type="text" class="form-control" name="other_charge" id="other_charge" value="{{ old('other_charge') }}" placeholder="Other Shipping Charge">
                    ...
                    <div class="form-group {{ $errors->has('inside_dhaka_free_of_charge')? 'has-error':'' }}">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="inside_dhaka_free_of_charge" id="inside_dhaka_free_of_charge" value="yes">
                    ...
                    <div class="form-group {{ $errors->has('free_of_charge')? 'has-error':'' }}">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="free_of_charge" id="free_of_charge" value="yes">
                                Free Shipment
                            </label>
                        </div>
...
{{--                    <div class="form-group  {{ $errors->has('expire_date')? 'has-error':'' }}">
                        ...
                        <div class="input-group" >
                            ...
                            <input  id="expire_date" name="expire_date" class="form-control" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask="" type="text" {{ old('expire_date') }}>
                    ...
                    <div class="form-group {{ $errors->has('secondary_front_image')? 'has-error':'' }}">
                        ...
                        <input   type="text" class="form-control" name="secondary_front_image" id="secondary_front_image" value="" >
    ...
    <div class="modal fade" id="myModalSecondary">
        <div class="modal-dialog">
            <div class="modal-content" style="min-width: 731px;">
                ...
                <div class="modal-body">
                    <iframe width="700" height="400" src="dialog?type=2&field_id=secondary_front_image'&fldr=" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
