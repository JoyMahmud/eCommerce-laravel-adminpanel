        ...
        <div class="content">
            ...
            <table  id="order" style="width: 85%;margin: 0 auto;padding-top: 13px;margin-top: 14px;">
                ...
                <tr>
                    ...
                    <td style="background-color: #ABD07E;padding: 6px;font-size: 15px;font-weight: bolder;color: #ffffff;">Preorder Total</td>
                    <td style="background-color: #ABD07E;padding: 6px;font-size: 15px;font-weight: bolder;color: #ffffff;"></td>
                    <td style="background-color: #ABD07E;padding: 6px;font-size: 15px;font-weight: bolder;color: #ffffff;"></td>
                    <td style="background-color: #ABD07E;padding: 6px;font-size: 15px;font-weight: bolder;color: #ffffff;">{{$orderDetails->pre_order_amount}}</td>
                ...
                <tr>
                    ...
                    <td style="padding: 6px;font-size: 15px;font-weight: bolder;color: #ffffff;"></td>
                    <td style="background-color:hsla(120,100%,75%,0.3);padding: 6px;font-size: 15px;font-weight: bolder;color: #fffffff;">{{$orderDetails->pre_order_amount ==' ' ? '0.00' : $orderDetails->booking_payment_status =='verification' ? 'Verification Unsuccessful' : $orderDetails->pre_order_amount }}</td>
                ...
                <tr>
                    ...
                    <td style="padding: 6px;font-size: 15px;font-weight: bolder;color: #ffffff;"></td>
                    <td style="padding: 6px;font-size: 15px;font-weight: bolder;color: #ffffff;"></td>
                    <td style="background-color:hsla(120,100%,75%,0.3);padding: 6px;font-size: 15px;font-weight: bolder;color: #fffffff;">{{$orderDetails->pre_order_amount ==' ' ?  $orderDetails->price : $orderDetails->booking_payment_status =='verification' ? $orderDetails->price : ($orderDetails->price-$orderDetails->pre_order_amount) }}</td>
